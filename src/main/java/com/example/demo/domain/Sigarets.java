...
public class Sigarets {
    ...
    public Sigarets(int id, double bond, double kent, double parlament, double winston, double lm, double malboro, double rotmans, double ld, double fmorris, double aliance, double java, double optima, double petr, double maksim, double crests, double vog, double glamur, double kiss, double esse, double quin, double lady, double mor, double chester, double radopy, double stuardessa, double stolichniye, double donskoy, double troyka, double fast, double royal, double manchester, double prestigue, double premier, double cosmos, double next, double magnat, double minsk, double souz) {
        super();
        this.id = id;
        this.bond = bond;
        this.kent = kent;
